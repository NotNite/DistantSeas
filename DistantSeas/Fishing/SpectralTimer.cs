...
public class SpectralTimer {
    ...
    private uint zone = 0;
    private const uint SpectralTime = 2 * 60;
    ...
    public SpectralTimer() {
        this.stopwatch = new Timer(1000);
        this.stopwatch.Elapsed += this.OnTimedEvent;
        this.stopwatch.AutoReset = true;
    ...
    public void Dispose() {
        this.stopwatch.Stop();
        this.stopwatch.Elapsed -= OnTimedEvent;
