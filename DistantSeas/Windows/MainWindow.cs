...
public class MainWindow : DistantSeasWindow {
    ...
    public override void Draw() {
        ...
        if (this.currentSection != null) {
            using (var child = ImRaii.Child("##DistantSeasSection", ImGui.GetContentRegionAvail())) {
                if (child.Success) this.currentSection.Draw();
            }
        }
    }
    ...
    private void DrawSidebar() {
        ...
        using (var child = ImRaii.Child("##DistantSeasSidebar", size, true)) {
            if (child.Success) {
